...
def render_behavior_marketing(prob: float, behavior_type: str) -> None:
    ...
    st.markdown("### Precision Marketing Suggestions")
    st.info(advice)
...
def render_bgnbd_module(data_dir: str = ".") -> None:
    st.subheader("Customer Lifetime Value Analysis (BG/NBD)")
...
def render_intent_prediction_module() -> None:
    st.subheader("Module 1: Real-time Intent Prediction")
...
<span style="font-family:'Playfair Display',Georgia,serif;font-size:1.05rem;font-weight:700;color:#E2B659;letter-spacing:0.06em">Modules</span>
    ...
    _module_options = [
        "Module 1: Real-time Intent Prediction",
        "Module 2: Customer LTV Analysis (BG/NBD)",
    ...
    if module == "Module 1: Real-time Intent Prediction":
        render_intent_prediction_module()
    elif module == "Module 2: Customer LTV Analysis (BG/NBD)":
