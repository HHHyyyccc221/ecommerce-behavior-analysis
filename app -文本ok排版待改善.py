...
def render_behavior_marketing(prob: float, behavior_type: str) -> None:
    ...
    # 删除多余空行，包裹居中标题并调整 margin-top 使其与左侧仪表盘的视觉重心在同一水平线
    st.markdown(
        """
        <div style='margin-top: 2.8rem; margin-bottom: 0.8rem;'>
...
<span style="font-family:'Playfair Display',Georgia,serif;font-size:1.6rem;font-weight:700;color:#E2B659;letter-spacing:0.06em">Modules</span>
</div>""",
        unsafe_allow_html=True,
    )
